...
# Schéma pour les données d'entrée avec validation Pydantic
...
def get_latest_run_id(experiment_name="price_prediction_local"):
    ...
    if experiment:
        ...
        print(f"✅ Dernier run_id trouvé : {runs[0].info.run_id}")
    return None
...
async def lifespan(app: FastAPI):
    ...
    if run_id:
        ...
        print("❌ Aucun run_id trouvé dans MLflow.")
        loaded_model = None
...
def root():
    """
    Page d'accueil avec interface HTML moderne et interactive
    """
...
if __name__ == "__main__":
    import uvicorn
    print("🚀 Démarrage de l'API GetAround...")
